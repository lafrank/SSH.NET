...
namespace Renci.SshNet
{
  ...
  public class NetConfClient : BaseClient
  {
    ...
    /// <summary>
    /// Event to acquire custom ClientCapabilities
    /// </summary>
    public event GetCapability OnGetClientCapability;
    ...
    {
      base.OnConnected();
      XmlDocument _clientCapabilities;
      _clientCapabilities = OnGetClientCapability?.Invoke(this, new EventArgs());
      if (_clientCapabilities == null)
      {
        // load default client capabilities
        string capa = @"
<hello xmlns=""urn:ietf:params:xml:ns:netconf:base:1.0"">
    <capabilities>
        ...
        _clientCapabilities = new XmlDocument();
        _clientCapabilities.LoadXml(capa);
      }
      _netConfSession = ServiceFactory.CreateNetConfSession(Session, OperationTimeout, _clientCapabilities);
  ...
  /// <summary>
  /// Delegate to get client capability
  /// </summary>
  /// <param name="sender"></param>
  /// <param name="e"></param>
  /// <returns>The XmlDocument object describing NetConf client capability</returns>
  public delegate XmlDocument GetCapability(object sender, EventArgs e);
}
